...
-논리 연산자는 boolean값만 다룰 수 있지만 자바스크립트에서만 
 ...
 -null, 0, NaN(Not a Number), 빈 문자열(""),undefined는 false로 간주한다.

AND 연산자 (&&) 
-피연산자가 모두 true일 경우에 true를 반환하고 나머지는 false를 반환

OR 연산자 (||)
-피연산자가 하나라도 true일 경우에 true를 반환하고 나머지는 false를 반환
...
let a1 = true && true;
let a2 = true && false;
let a3 = 111 && 222; //기본적으로 숫자나 문자는 true이다.
// 뒤에문자가 출력됨
console.log(a1);
console.log(a2);
console.log(a3);
...
console.log(o2);
let o3 = 3 || 4;
console.log(o3); //앞에서 true면 앞에값 반환
let o4 = null || undefined;
console.log(o4);
